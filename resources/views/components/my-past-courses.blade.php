...
<div class="user-courses-table m-10 p-8 bg-slate-200">
    ...
    <div class="flex flex-col md:flex-row items-center justify-between pb-6">
        <div>
            <span class="text-4xl pb-4 mb-2">My Past Courses</span>
        </div>
        <div class="flex items-center justify-between ">
            <form class="flex items-center p-2 rounded-md bg-slate-200">

                <input class="bg-gray-50 outline-none ml-1 block " type="text" name="" id="search-past-course"
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-4">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400" id="my-past-courses-table">
            ...
            <tbody class="text-black">
                @foreach ($user->courses as $course)
                    ...
                    <tr
                        class=" border-b hover:bg-opacity-90 text-base bg-blue-200" 
>
